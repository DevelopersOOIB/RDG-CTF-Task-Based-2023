...
Да это обычная схема разделения секрета Шамира. Только я её усложнил и мне интересно, кто сможет полностью востановить многочлен.
...
# Flag
RDGCTF{I_love_the_Jordan_Gauss_method}
